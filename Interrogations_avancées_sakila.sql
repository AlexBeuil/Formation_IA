...
### Le mois doit être écrit en toute lettre et le résultat doit
### s'afficher dans une seul colonne.
...
### 2. Afficher la colonne qui donne la durée de location des films
###	   en jour.
...
### 4. Afficher les emprunts rélaisé entre le mois d'avril et 
###    le moi de mai. La liste doit être trié du plus ancien au plus 
###    récent.
...
###    Ajouter une colonne qui affichera <<oui>> si <<NC-17>> et
###    <<non>> sinon.
...
### 7. Fournir la liste des catégorie qui commence par un "A" ou
###    un "C". (Utiliser LEFT).
...
### 9. Lister les premiers acteurs en remplaçant dans leur prenom les 
###    E par des A.
...
### 2. Afficher les films dans les quel à joué << JENNIFER DAVIS>> sortie 
###    en 2006
...
AND year(film_actor.last_update) = 2006  ;
...
### 4. Afficher les films louer par des personnes habitant à << Woodrige >>. 
